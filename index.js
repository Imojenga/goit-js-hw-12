import{a as w,i as u,S as x}from"./assets/vendor-B6jJ9_I0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))o(l);new MutationObserver(l=>{for(const s of l)if(s.type==="childList")for(const y of s.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&o(y)}).observe(document,{childList:!0,subtree:!0});function a(l){const s={};return l.integrity&&(s.integrity=l.integrity),l.referrerPolicy&&(s.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?s.credentials="include":l.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(l){if(l.ep)return;l.ep=!0;const s=a(l);fetch(l.href,s)}})();const h=t=>`<li class="gallery-item">
  ...
  </li>`,f=(t,e)=>{const a={params:{key:"48469093-05e82502d9118a70767c30ea2",q:t,image_type:"photo",orientation:"horizontal",safesearch:!0,page:e,per_page:15}};return w.get("https://pixabay.com/api/",a)},L=document.querySelector(".search-form"),p=document.querySelector(".gallery"),n=document.querySelector(".load-more-btn"),r=document.querySelector(".loader");r.style.display="none";let i=1,c="",m,g,d,b;const S=t=>{window.scrollBy({top:t,behavior:"smooth"})},v=async t=>{try{if(t.preventDefault(),p.innerHTML="",r.style.display="block",c=t.currentTarget.elements.user_query.value.trim(),!c){t.currentTarget.elements.user_query.value="",r.style.display="none";return}i=1,n.classList.add("is-hidden");const{data:e}=await f(c,i);if(r.style.display="none",e.total===0){u.error({message:"Sorry, there are no images matching</br> your search query. Please try again!",position:"topRight"}),L.reset();return}e.totalHits/e.hits.length>1&&(n.classList.remove("is-hidden"),n.addEventListener("click",q)),e.totalHits===e.hits.length&&u.info({message:"We're sorry, but you've reached the end of search results.",position:"topRight"});const a=e.hits.map(o=>h(o)).join("");p.innerHTML=a,m=new x(".gallery a",{captionsData:"alt"}),m.refresh(),g=document.querySelector(".gallery-item"),d=g.getBoundingClientRect(),b=(d.bottom-d.top)*2+48}catch(e){r.style.display="none",console.log(e)}};L.addEventListener("submit",v);const q=async t=>{try{i++,r.style.display="block";const{data:e}=await f(c,i);r.style.display="none";const a=e.hits.map(o=>h(o)).join("");p.insertAdjacentHTML("beforeend",a),m.refresh(),S(b),i===Math.ceil(e.totalHits/e.hits.length)&&(n.classList.add("is-hidden"),u.info({message:"We're sorry, but you've reached the end of search results.",position:"topRight"}))}catch(e){r.style.display="none",console.log(e)}};
